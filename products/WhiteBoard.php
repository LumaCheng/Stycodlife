<?php
  session_start();
  $product_name = "White Board";
  $_SESSION['product_name'] = $product_name;

  $cookie_name = "cookie10";
  $keeptime = 3600*10;
  setcookie("product10", time(), time() + $keeptime, "/");
...
<div class="w3-sand w3-large w3-grayscale-min">
  ...
  <div class="w3-container" id="search" style="padding-bottom:32px;">
    <div class="w3-content" style="max-width:700px">
        <h1>White Board</h1>
        <ul>
        <li> Whiteboard on both sides. Chrome finish on main frame.</li>
        <li> Assembly required. 10 Year Warranty on Board.</li>
        <li> Board Size: 48"W X 36"H. Frame Size: 23"D.</li>
        </ul>
        <img src="../image/products/WhiteBoard.jpg" style="width:60%;max-width:600px" class="w3-margin-top">
