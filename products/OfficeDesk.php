...
$_SESSION['product_name'] = $product_name;
  ...
  $cookie_name = "cookie8";
  $keeptime = 3600*10;
  setcookie("product8", time(), time() + $keeptime, "/");
...
<div class="w3-sand w3-large w3-grayscale-min">
  ...
  <div class="w3-container" id="search" style="padding-bottom:32px;">
    <div class="w3-content" style="max-width:700px">
        <h1>Office Desk</h1>
        <ul>
        <li>Slide-out keyboard/mouse shelf</li>
        <li>Lower drawer holds letter or European size hanging files</li>
        <li>Door and drawers can be fastened on the left or right side</li>
        </ul>
        <img src="../image/products/OfficeDesk.jpg" style="width:60%;max-width:600px" class="w3-margin-top">
