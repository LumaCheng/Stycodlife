<?php
session_start();
$product_name = "Wireless Charging";
$_SESSION['product_name'] = $product_name;

  $cookie_name = "cookie4";
  $keeptime = 3600*10;
  setcookie("product4", time(), time() + $keeptime, "/");
...
<div class="w3-sand w3-large w3-grayscale-min">
  <div class="w3-container" id="search" style="padding-bottom:32px;">
    <div class="w3-content" style="max-width:700px">
        ...
        <ul>
        <li>AC charger for 48W 12V 4A For Microsoft Surface Pro 3 Docking Station (Old Version)Model 1627</li>
        <li>Quickly charger, Over Heat protection, well packaged.</li>
        <li>Notice : This Is A adapter for surface Docking Station , please compare the connector size and Adapter voltage 12V before add to cart.</li>
        </ul>
        <img src="../image/products/Charging.jpg" style="width:60%;max-width:600px" class="w3-margin-top">
