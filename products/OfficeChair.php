...
$_SESSION['product_name'] = $product_name;
  ...
  $cookie_name = "cookie7";
  $keeptime = 3600*10;
  setcookie("product7", time(), time() + $keeptime, "/");
...
<div class="w3-sand w3-large w3-grayscale-min">
  ...
  <div class="w3-container" id="search" style="padding-bottom:32px;">
    <div class="w3-content" style="max-width:700px">
        <h1>Office Chair</h1>
        <ul>
        <li>Stylish and comfortable for home offices</li>
        <li>Neutral tone is a great accent to a business setting</li>
        <li>Memory foam for added comfort</li>
        </ul>
        <img src="../image/products/OfficeChair.jpg" style="width:60%;max-width:600px" class="w3-margin-top">
