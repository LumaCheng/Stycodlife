<?php
  session_start();
  $product_name = "Countertop Water Cooler";
  $_SESSION['product_name'] = $product_name;

  $cookie_name = "cookie9";
  $keeptime = 3600*10;
  setcookie("product9", time(), time() + $keeptime, "/");
...
<div class="w3-sand w3-large w3-grayscale-min">
  ...
  <div class="w3-container" id="search" style="padding-bottom:32px;">
    <div class="w3-content" style="max-width:700px">
        <h1>Countertop Water Cooler </h1>
        <ul>
        <li> Avalon’s Countertop Top Loading Water Cooler Dispenser features a slim design that won’t look bulky</li>
        <li> Our top loading water cooler dispenser saves time when you need to make a quick cup of tea.</li>
        <li>This water cooler dispenser loads from the top & allows you to spot if the dispenser is running out of water.</li>
        </ul>
        <img src="../image/products/Water.jpg" style="width:60%;max-width:600px" class="w3-margin-top">
