<?php
session_start();
$product_name = "Coated Plastic Cover";
$_SESSION['product_name'] = $product_name;

  $cookie_name = "cookie5";
  $keeptime = 3600*10;
  setcookie("product5", time(), time() + $keeptime, "/");
  if(!isset($_COOKIE[$cookie_name])) {
      setcookie($cookie_name, 1, time() + $keeptime, "/");
  } else {
    setcookie($cookie_name, $_COOKIE["cookie5"]+1, time() + $keeptime, "/");
  }
?>
<html>
...
<div class="w3-sand w3-large w3-grayscale-min">
  <div class="w3-container" id="search" style="padding-bottom:32px;">
    <div class="w3-content" style="max-width:700px">
        <h1>Coated Plastic Cover</h1>
        <ul>
        <li>  Unique marble pattern case for MacBook Air 13" (A1369 & A1466), protects your MacBook from accidental knocks and scratches.</li>
        <li>  NO CUT OUT design, and Apple Logo is invisible (for the special pattern and produce technology) through the plastic case even laptop is turn on and screen brightness is up.</li>
        <li>  Specially port design for USB, Thunderbolt, HDMI, SD Card, Power, Audio Out. Don't need to remove the case when you want to plug in charger, cable or headset.</li>
        <ul>
        <img src="../image/products/LaptopCover.jpg" style="width:60%;max-width:600px" class="w3-margin-top">
