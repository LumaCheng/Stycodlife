<?php
   ...
   $cookie_name = "cookie1";
  $keeptime = 3600*10;
  setcookie("product1", time(), time() + $keeptime, "/");
  if(!isset($_COOKIE[$cookie_name])) {
      setcookie($cookie_name, 1, time() + $keeptime, "/");
  } else {
    setcookie($cookie_name, $_COOKIE["cookie1"]+1, time() + $keeptime, "/");
  }
...
<div class="w3-sand w3-large w3-grayscale-min">
  <div class="w3-contaizner" id="search" style="padding-bottom:32px;">
    <div class="w3-content" style="max-width:700px">
        <h1>Backpack</h1>
        <ul>
        <li>Large multi-compartment backpack with a padded sleeve for laptops; holds up to 17" notebook.</li>
        <li>Mesh water bottle pockets at side.</li>
        <li>Organizational compartments for pens, keys, and cell phone.</li>
        </ul>
        <img src="../image/products/Backpack.jpg" style="width:40%;" >
