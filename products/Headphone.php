<?php
  ...
  $cookie_name = "cookie2";
  $keeptime = 3600*10;
  setcookie("product2", time(), time() + $keeptime , "/");
...
<div class="w3-sand w3-large w3-grayscale-min">
  <div class="w3-container" id="search" style="padding-bottom:32px;">
    <div class="w3-content" style="max-width:700px">
        ...
        <ul>
        <li> Feel the power of EXTRA BASS. Connectivity Technology: Wireless</li>
        <li> High quality wireless audio with Bluetooth and NFC</li>
        <li> Optimize your sound settings with the Sony Headphones Connect app.</li>
        </ul>
        <img src="../image/products/Headphone.jpg" style="width:60%;max-width:600px" class="w3-margin-top">
